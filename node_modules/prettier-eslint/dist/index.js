...
function _taggedTemplateLiteral(strings, raw) { return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /* eslint no-console:0, global-require:0, import/no-dynamic-require:0 */


var logger = (0, _log2.default)(getDefaultLogLevel());
...
function format(options) {
  ...
  var filePath = options.filePath,
      ...
      _options$eslintConfig = options.eslintConfig,
      eslintConfig = _options$eslintConfig === undefined ? getConfig(filePath, eslintPath) : _options$eslintConfig,
  ...
  logger.trace((0, _commonTags.stripIndent)(_templateObject, (0, _indentString2.default)(text, 2)));
  var pretty = prettify(text, formattingOptions.prettier, prettierPath);
  logger.trace((0, _commonTags.stripIndent)(_templateObject2, (0, _indentString2.default)(pretty, 2)));
  var eslintFixed = eslintFix(pretty, formattingOptions.eslint, eslintPath);
  logger.trace((0, _commonTags.stripIndent)(_templateObject3, (0, _indentString2.default)(pretty, 2)));
  return eslintFixed;
}
...
function prettify(text, formatOptions, prettierPath) {
  ...
  try {
    ...
    logger.error((0, _commonTags.oneLine)(_templateObject4, prettierPath));
    throw error;
  }
  try {
...
function getTextFromFilePath(filePath) {
  try {
    logger.trace((0, _commonTags.oneLine)(_templateObject5, filePath));
    return _fs2.default.readFileSync(filePath, 'utf8');
  } catch (error) {
    logger.error((0, _commonTags.oneLine)(_templateObject6, filePath));
    throw error;
  }
}
...
function getConfig(filePath, eslintPath) {
  ...
  logger.trace((0, _commonTags.oneLine)(_templateObject7, filePath || process.cwd()));
...
function getModulePath() {
  ...
  try {
    ...
    logger.debug((0, _commonTags.oneLine)(_templateObject8, moduleName), error.message, error.stack);
...
function getESLintCLIEngine(eslintPath, eslintOptions) {
  try {
    ...
    logger.error((0, _commonTags.oneLine)(_templateObject9, eslintPath));
    throw error;
  }
}
