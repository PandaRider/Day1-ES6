...
var formatFilesFromArgv = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(_ref2) {
    var fileGlobs = _ref2._,
        _ref2$logLevel = _ref2.logLevel,
        logLevel = _ref2$logLevel === undefined ? logger.getLevel() : _ref2$logLevel,
        stdin = _ref2.stdin,
        write = _ref2.write,
        eslintPath = _ref2.eslintPath,
        prettierPath = _ref2.prettierPath,
        _ref2$ignore = _ref2.ignore,
        ignoreGlobs = _ref2$ignore === undefined ? [] : _ref2$ignore,
        _ref2$eslintIgnore = _ref2.eslintIgnore,
        applyEslintIgnore = _ref2$eslintIgnore === undefined ? true : _ref2$eslintIgnore;
    var prettierESLintOptions, cliOptions;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            logger.setLevel(logLevel);
            prettierESLintOptions = { logLevel, eslintPath, prettierPath };
            cliOptions = { write };
            ...
            return _context.abrupt('return', formatStdin(prettierESLintOptions));

          case 7:
            return _context.abrupt('return', formatFilesFromGlobs(fileGlobs, [].concat((0, _toConsumableArray3.default)(ignoreGlobs)), // make a copy to avoid manipulation
  ...
  return function formatFilesFromArgv(_x) {
    return _ref.apply(this, arguments);
  };
}();

var formatStdin = function () {
  var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(prettierESLintOptions) {
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            stdinValue = _context2.sent.trim();
            _context2.prev = 3;
            formatted = (0, _prettierEslint2.default)((0, _extends3.default)({ text: stdinValue }, prettierESLintOptions));

            console.log(formatted);
            return _context2.abrupt('return', Promise.resolve(formatted));

          case 9:
            _context2.prev = 9;
            _context2.t0 = _context2['catch'](3);

            logger.error('There was a problem trying to format the stdin text', `\n${(0, _indentString2.default)(_context2.t0.stack, 4)}`);
            process.exitCode = 1;
            return _context2.abrupt('return', Promise.resolve(stdinValue));
...
var formatFilesFromGlobs = function () {
  var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(fileGlobs, ignoreGlobs, cliOptions, prettierESLintOptions, applyEslintIgnore) {
    var concurrentGlobs, concurrentFormats;
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            concurrentGlobs = 3;
            concurrentFormats = 10;
  ...
  return function formatFilesFromGlobs(_x3, _x4, _x5, _x6, _x7) {
